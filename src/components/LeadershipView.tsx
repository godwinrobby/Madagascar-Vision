...
import { LEADERS, SECTORS, SUBSIDIARY_TEAMS, getLeaderMeta } from '../data/corporateData';
...
export function LeadershipView({ language }: LeadershipViewProps) {
  ...
  // getLeaderMeta imported from corporateData
  ...
  // SUBSIDIARY_TEAMS imported from corporateData
