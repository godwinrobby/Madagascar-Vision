...
export interface SubsidiaryTeamRole {
  title: Record<'EN' | 'FR' | 'MG', string>;
  name: string;
}

export interface SubsidiaryTeam {
  id: string;
  name: string;
  roles: SubsidiaryTeamRole[];
}

export const SUBSIDIARY_TEAMS: SubsidiaryTeam[] = [
  {
    id: 'ngo',
    name: 'ViMa NGO',
    roles: [
...
export function getLeaderMeta(fullName: string) {
